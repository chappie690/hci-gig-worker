  ...
  return (
    <AppShell user={user} title="Reviews" subtitle="Learner feedback" activeHref="/trainer/reviews">
      <PageSection
        ...
        title="Track learner trust signals for your courses"
        description="SkillPilot AI does not collect formal ratings yet, so this prototype shows review-readiness signals from enrollment and completion data."
      />
